...
<head>
    ...
    <style>
        ...
        .access-hero {
            background-image: linear-gradient(rgba(77, 127, 184, 0.9), rgba(93, 140, 196, 0.9)), url('bg-images/images-26.png');
        ...
        .access-hero .hero-subtitle {
            color: white !important;
            text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.5);
        }
        
        .access-hero .hero-badge {
            background: rgba(255, 255, 255, 0.2);
            backdrop-filter: blur(10px);
            border: 1px solid rgba(255, 255, 255, 0.3);
        }
        
        .access-hero .hero-badge span {
            color: white !important;
            font-weight: 600;
        }
        
        .access-hero .hero-badge i {
            color: white !important;
        }
        ...
        <div class="hero-container">
            <div class="hero-content" data-aos="fade-up" data-aos-duration="1000">
                ...
                <div class="hero-actions" data-aos="fade-up" data-aos-delay="1000">
                    ...
                    <a href="all-issues.php" class="btn btn-outline btn-large">
